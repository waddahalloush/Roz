...
class MyProfileScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return DefaultTabController(
      length: 2,
      child: SafeArea(child:Consumer<MyProfileProvider>(
          ...
          return Column(
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    myType.imageProfile != null
                        ? ProfilePictureWidget(
                            image: FileImage(myType.imageProfile!))
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: Align(
                              alignment:
                                  context.read<AppProvider>().locale.languageCode ==
                                          'ar'
